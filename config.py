...
RISK_PROFILE = {
    ...
    "max_pe_ratio"       : 80,              # Avoid stocks with P/E above this
    ...
    "max_single_stock_pct": 30,             # No single stock > 10% of portfolio
    "max_sector_pct"     : 50,             # No single sector > 30% of portfolio
}
